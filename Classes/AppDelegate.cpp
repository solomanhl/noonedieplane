...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
		...
		glview->setFrameSize(director->getVisibleSize().width, director->getVisibleSize().height);//屏幕适配
    }

	glview->setDesignResolutionSize(720, 1280, ResolutionPolicy::EXACT_FIT);//屏幕适配,基准是华为p6
	...
	//sinaConfigDict->setObject(String::create(""), "app_id");   
...
void AppDelegate::initPlatformConfig()
{
	...
	wcConfigDict->setObject(String::create("wx4c8cdf1d0d514686"), "app_id");
